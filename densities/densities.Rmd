...
dplyr::select(mdn_sa, State_Abbr, MSA_Name, SA_Code, Popn_Est, Area_km2, Density, Cum_Popn_Perc)
```
...
dplyr::select(mdn_msa_popn, MSA_Name, Popn_Est, Area_km2, Density, Cum_Popn_Perc)
```
...
dplyr::select(mdn_msa_density, MSA_Name, Popn_Est, Area_km2, Density, Cum_Popn_Perc)
```
