...
```{r sapopnstats}
tbl <- ShowStats(all_data, stat_col = ppn_est)
htmltools::div(class = "table", tbl)
```
<br>  
...
``` {r msapopnstats}
tbl <- ShowStats(all_data, msa_name, ppn_est)
htmltools::div(class = "table", tbl)
```
<br>  
...
``` {r saareastats}
tbl <- ShowStats(all_data, stat_col = area)
htmltools::div(class = "table", tbl)
```
<br>  
...
##### And by Metropolitan Area
``` {r msaareastats}
tbl <- ShowStats(all_data, msa_name, area)
htmltools::div(class = "table", tbl)
```
<br>  
...
tbl <- ShowMedianTable(mdn_sa, c(ccode, sabbr, msa_name, sa_code, ppn_est, area, density, cum_pct))
htmltools::div(class = "table", tbl)
